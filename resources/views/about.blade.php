        ...
        <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
            <div class="p-4 md:w-1/3 flex">
                ...
                <div class="flex-grow pl-6">
                    ...
                    <p class="leading-relaxed text-base parrafo-cuerpo text-gray-700">En nuestro despacho, nuestra misión es proporcionar asesoría
            ...
            <div class="p-4 md:w-1/3 flex">
                ...
                <div class="flex-grow pl-6">
                    ...
                    <p class="leading-relaxed text-base parrafo-cuerpo text-gray-700">Colaboramos estrechamente con nuestros clientes, creyendo que
