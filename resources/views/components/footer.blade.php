<div>
  <div class="grid sm:grid-cols-2 px-8 -mb-10">
    <div class="bg-indigo-500 text-white p-7 ">
      ...
      <p class="text-lg">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there
        live the
        blind texts.</p>
    </div>
    <div class="bg-indigo-700 text-white p-7">
      ...
      <p class="mt-3 text-lg">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,
        there live the blind texts.</p>
    </div>
  </div>
  <div class="bg-slate-900 text-white px-8 py-8 h-[68vh] flex flex-col justify-center">
    ...
    <div class="text-gray-500 my-8 text-center">
      Copyright ©2024 All rights reserved | This template is made with by <a
        class="text-white cursor-pointer hover:text-blue-700" href="http://www.siccoms.com/" target="_blank">SICCOMS</a>
