        ...
        <div class="max-w-sm mx-auto my-5">
            <form 
                ...
                <div class="dz-message flex flex-col items-center justify-center text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-camera-down" width="52" height="52" viewBox="0 0 24 24" stroke-width="1.5" stroke="#9ca3af" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Arrastre y suelte su imagen aquí, o haga clic para seleccionar la imagen</p>
                </div>
            </form>
        </div>
