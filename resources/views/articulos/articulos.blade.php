...
@section('contenido')
    <section class="my-4 rounded-md py-4">
        <aside class=" mt-4 md:mt-0 space-y-2 rounded-md  p-1 bg-white dark:bg-gray-800 mx-auto lg:px-12">
            <h2
            ...
            @foreach ($articles as $article)
                <article class="p-6">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{$article->url}}" class="inline-flex items-center font-medium text-primary-600 hover:underline">
                            Leer más
