            ...
            <div class="mt-5 mb-8 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div
                    ...
                    <div
                        class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                        <h2 class="font-dmserif text-3xl font-bold text-white capitalize">
                            {{ __('site/areas.areas-derecho-mercantil') }}</h2>
                        <p
                            class="mb-3 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                            {{ __('site/areas.derecho-mercantil-descripcion') }}</p>
                ...
                <div
                    ...
                    <div
                        class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                        <h2 class="font-dmserif text-3xl font-bold text-white capitalize">
                            {{ __('site/areas.areas-derecho-tributario') }}</h2>
                        <p
                            class="mb-3 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                            {{ __('site/areas.derecho-tributario-descripcion') }}</p>
                ...
                <div
                    ...
                    <div
                        class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                        <h2 class="font-dmserif text-3xl font-bold text-white capitalize">
                            {{ __('site/areas.areas-derecho-amparo') }}</h2>
                        <p
                            class="mb-3 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                            {{ __('site/areas.derecho-amparo-descripcion') }}</p>
                ...
                <div
                    ...
                    <div
                        class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                        <h2 class="font-dmserif text-3xl font-bold text-white capitalize">
                            {{ __('site/areas.areas-derecho-constitucional') }}</h2>
                        <p
                            class="mb-3 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                            {{ __('site/areas.derecho-constitucional-descripcion') }}</p>
                        <a href="{{ route('area.constitucional') }}"
                            class="rounded-full bg-neutral-900 py-2 px-3.5 font-com text-sm capitalize text-white shadow shadow-black/60">Ver
                            Más</a>
                    </div>
                </div>
