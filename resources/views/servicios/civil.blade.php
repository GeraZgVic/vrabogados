...
<div>
    ...
    <section class="w-full h-screen animate-fade bg-[url('https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&w=1742&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')]  bg-cover bg-no-repeat bg-center flex flex-col justify-center items-center ">
        <div
            ...
            <div class="items-center md:flex md:space-x-6">
                <div class="md:w-1/2 animate-fade-right animate-once animate-duration-[2500ms] animate-ease-in">
                    ...
                    <p class="parrafo-cuerpo text-gray-800">Los códigos civiles disponen que las personas físicas
                        ...
                        además que desde el momento en que un individuo es concebido, entra bajo la protección de la ley
                        y se tiene por nacido para efectos legales.</p>
                    <p class="parrafo-cuerpo text-gray-600"> La minoría de edad, el estado de interdicción, y otras
                        incapacidades jurídicas, son
                        restricciones a la personalidad jurídica, sin embargo los incapaces pueden ejercitar sus
                        derechos o contraer obligaciones por medio de sus representantes.</p>
                </div>
