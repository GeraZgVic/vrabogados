    ...
    <section
        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 bg-black/60">
            <a href="{{ route('home.index') }}" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 ">
                <img class="w-full md:h-24 mr-2" src="{{ asset('img/logo_blanco.png') }}" alt="logo">
            </a>
                    ...
                    <form class="space-y-4 md:space-y-6" action="{{ route('login') }}" method="POST">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email"
                                ...
                                rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 @error('email') border-red-400 @enderror"
                                placeholder="name@correo.com">
                            @error('email')
                            <div class="m-2 mb-4 text-sm text-center text-red-800 rounded-lg" role="alert">
                        ...
                        <div>
                            ...
                            <input type="password" name="password" id="password" placeholder="••••••••"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 @error('password') border-red-400 @enderror"">
                            @error('password')
                            <div class="m-2 mb-4 text-sm text-center text-red-800 rounded-lg" role="alert">
                                <span class="font-medium"></span> {{$message}}
                            </div>
