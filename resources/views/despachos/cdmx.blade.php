...
<section class="relative h-screen flex flex-col items-center justify-center text-center text-white ">
    ...
    <div class="video-content z-10 container max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-20 lg:px-8 space-y-6">
        <h1 class="titulos">Contáctanos en Ciudad de México</h1>
        <h3 class="parrafo-cuerpo">Viveros Romero, tu despacho de abogados de confianza en Ciudad de México. Con más de 20 años de experiencia en derecho civil, penal y laboral, estamos aquí para proteger tus derechos y resolver tus problemas legales eficazmente.</h3>
    </div>
</section>
