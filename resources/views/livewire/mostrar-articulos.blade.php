...
<article class="p-6">
    ...
    <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900"><a href="#">"La Importancia
            de Consultar con un Abogado Comercial" </a></h2>
...
<article class="p-6">
    ...
    <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900"><a href="#">Cómo un Abogado
            de Inmigración Puede Cambiar tu Vida</a></h2>
    <div class="flex justify-between items-center">
        <div class="flex items-center space-x-4">
            <img class="w-7 h-7 rounded-full" src="{{ asset('img/img-2.webp') }}"
                alt="Viveros Abogados avatar" />
